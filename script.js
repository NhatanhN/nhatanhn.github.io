...
windowSize = windowSize <= 600 ? windowSize * 0.8 : windowSize * 0.5;
...
function makeDraggable(elmnt) {
	...
	function elementDrag(e) {
		...
		if (
			newTop >= 0 &&
			newTop < container.clientHeight - 16 &&
			newLeft >= 0 &&
			newLeft < container.clientWidth - 16
		) {
...
function closeWindow(appId) {
	...
	setTimeout(() => {
		// allows time for transition animation to play
